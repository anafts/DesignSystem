...
export function SignIn() {
    ...
    const [isUserSingnedIn, setUserSingnedIn] = useState(false);

    function handleSignIn( event: FormEvent ) {
        event.preventDefault()

        setUserSingnedIn(true)
    }

    return (
        <div className='w-scree h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100'>
